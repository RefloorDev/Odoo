...
from fusion_refloor import rest
from fusion_refloor.configuration import Configuration
from fusion_refloor.exceptions import ApiTypeError, ApiValueError, ApiException
from fusion_refloor.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = SchedulingServicesApi()
        api_instance.schedule_existing_order  # this is an instance of the class Endpoint
        api_instance.schedule_existing_order()  # this invokes api_instance.schedule_existing_order.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.schedule_existing_order.callable or self.callable in this class
