...
class BaseAPI(object):
    ...
    def parse_payload(self,
                      ...
                      device_type=False):
        """
        ##device_type## parameter indicate the login user user android or ios phone
        which means we sent push notification in 'notification' tag in IOS, In the case of Android we use 'data' tag
